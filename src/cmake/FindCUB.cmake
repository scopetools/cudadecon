...
if(NOT EXISTS "${CUB_INCLUDE_DIR}")
    find_path(
        ...
        HINTS
            ...
            C:/Users/milkied10/Desktop/CudaDeconGit/projects/cub/cub
            /opt 
            $ENV{HOME}/opt 
            ENV CUB_DIR 
            ENV CUB_INCLUDE_DIR 
...
if(EXISTS "${CUB_INCLUDE_DIR}")
	file(READ "${CUB_INCLUDE_DIR}/README.md" ver)

	string(REGEX MATCH "Current release: v([0-9]*).([0-9]*)" _ ${ver})
	set(ver_major ${CMAKE_MATCH_1})
	set(ver_minor ${CMAKE_MATCH_2})

	message(STATUS "CUB version: ${ver_major}.${ver_minor}")
endif()
