...
texture<float, cudaTextureType2D, cudaReadModeElementType> a_texRef;
texture<float, cudaTextureType2D, cudaReadModeElementType> b_texRef;
texture<float, cudaTextureType2D, cudaReadModeElementType> offset_texRef;
